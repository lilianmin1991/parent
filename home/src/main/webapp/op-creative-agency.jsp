...
<body class="royal_preloader">	
					...
					<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse bg-faded">
						...
						<div class="collapse navbar-collapse justify-content-end" id="navbarNavMenuMain">
							<ul class="navbar-nav">
								...
								<li class="nav-item">
									<a href="#testimonials" class="nav-link">Virtue</a>
								</li>
								<li class="nav-item">
								...
								<li class="nav-item">
									<a href="#contact" class="nav-link">Say Hi</a>
								</li>
	...
	<script type="text/javascript" src="js/custom/custom-op-creative-agency.js"></script>  
<!-- End Document
================================================== -->
</body>
</html>