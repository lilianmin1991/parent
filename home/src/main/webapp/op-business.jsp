...
<body class="royal_preloader">	
					...
					<nav class="navbar navbar-toggleable-md navbar-inverse bg-inverse bg-faded nav-line-top">
						...
						<div class="collapse navbar-collapse justify-content-end" id="navbarNavMenuMain">
							<ul class="navbar-nav">
								...
								<li class="nav-item">
									<a href="#skill" class="nav-link">We Can</a>
								</li>
								<li class="nav-item">
								...
								<li class="nav-item">
									<a href="#team" class="nav-link">We Are</a>
								</li>
								<li class="nav-item">
	...
	<div class="section" id="home">
		...
		<div class="section full-height-2 over-hide">
			...
			<div class="hero-bottom-2-wrap z-bigger">
				<div class="container parallax-fade-top">
					<div class="row mb-5">
						<div class="col-md-12 mb-4">	
							<h3 class="color-white">Design must reflect the practical<br>and aesthetic in business.</h3>
						</div>	
	...
	<div class="section" id="skill">
		...
		<div class="section padding-top-bottom background-dark over-hide z-bigger-2">
			<div class="container">	
				<div class="row justify-content-center">
					<div class="col-xl-9">	
						<div class="quote-box-1 dark text-center">
		...
		<div class="section background-grey over-hide">
			<div class="container-fluid m-0 p-0 background-grey">
				<div class="row">		
					...
					<div class="col-md-6 align-items-stretch background-image-cover padding-top-bottom" style="background-image: url('img/content-5.jpg')">		
					</div>	
				</div>	
			</div>	
		</div>
		...
		<div class="section padding-top-bottom background-white over-hide">
			<div class="container">
				<div class="row justify-content-center">
					...
					<div class="clear"></div>
					<div class="col-md-4">	
						<div class="services-box-2 with-border text-center p-5 rounded-2" data-scroll-reveal="enter bottom move 40px over 0.8s after 0.2s">
							<i class="funky-ui-icon icon-Compass-2"></i>
							<h6 class="mt-4">Design Process</h6>	
							<p class="mt-3 mb-0">Design must reflect the practical and aesthetic in business.</p>	
						</div>
					</div>
			...
			<div class="grid-wraper clearfix">			
				<div class="grid-box float-inline third">
					<a href="project-image.jsp">
						<div class="portfolio-box-1 border-in">	
							<img  src="img/portfolio/grid/1.jpg" alt="" />	
							<div class="portfolio-mask-1"></div>
							<div class="portfolio-mask-border"></div>
							<h5>Project Name</h5>
							<p>we do magic</p>
						</div>	
					</a>
		...
		<div class="section padding-top-bottom background-grey over-hide">
			<div class="container">	
				<div class="row justify-content-center">
					...
					<div class="clear"></div>
					<div class="col-md-6" data-scroll-reveal="enter bottom move 40px over 0.8s after 0.2s">							 
					...
					<div class="col-md-6 mt-4 mt-md-0" data-scroll-reveal="enter bottom move 40px over 0.8s after 0.2s">					 
						<div class="blog-box-1 background-white drop-shadow">
					...
					<div class="col-md-6 mt-4" data-scroll-reveal="enter bottom move 40px over 0.8s after 0.2s"> 						 
						<div class="blog-box-1 background-white drop-shadow">
	...
	<div class="section" id="contact">
		...
		<div class="section background-grey over-hide">
			<div class="container-fluid m-0 p-0 background-grey">
				<div class="row">
					<div class="col-md-6 align-items-stretch background-image-cover padding-top-bottom" style="background-image: url('img/content-6.jpg')">		
					</div>		
					<div class="col-md-6 align-items-stretch">	
						<div class="section">
							<div id="cd-google-map">
								<div id="google-container" class="big-60-height"></div>
	...
	<div class="section padding-top background-white over-hide footer-1">
		<div class="container">
			<div class="row">
				<div class="col-md-3">
					<h6>Home concepts</h6>
	...
	<script type="text/javascript" src="js/custom/custom-op-business.js"></script>  
<!-- End Document
================================================== -->
</body>
</html>